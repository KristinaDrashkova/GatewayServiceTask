...
//        Gateway gateway = new Gateway("1245-1234-1234-1235", "name", "192.168.3.24");
//        peripheralDevice =
...
//        em.persist(peripheralDevice);
//
//        PeripheralDevice peripheralDeviceDb = peripheralDeviceDao.findById(peripheralDevice.getUid());
...
//
//        PeripheralDevice peripheralDeviceDb = peripheralDeviceDao.findById(peripheralDevice.getUid());
//        PeripheralDevice peripheralDeviceNull = peripheralDeviceDao.findById(2);
//        Assert.assertEquals(peripheralDevice, peripheralDeviceDb);
